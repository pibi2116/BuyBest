        ...
        <div className=" grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
          ...
          <div className="flex flex-col justify-center gap-6 sm:pt-0">
            ...
            <p data-aos="fade-up" className="text-sm text-gray-500 tracking-wide leading-5 ">
              Get ready for summer with unbeatable style and savings! Enjoy up to 50% off on our hottest summer collection — from breezy dresses to cool casuals. Refresh your wardrobe with fresh colors and lightweight fabrics, perfect for sunny days and warm nights. Don’t miss out, shop now while stocks last!
            </p>
